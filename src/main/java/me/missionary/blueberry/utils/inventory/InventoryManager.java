...
import me.missionary.blueberry.utils.inventory.opener.ChestInventoryOpener;
import me.missionary.blueberry.utils.inventory.opener.InventoryOpener;
import me.missionary.blueberry.utils.inventory.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    public InventoryManager(Blueberry plugin) {
        this.plugin = plugin;
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryDrag(InventoryDragEvent e) {
            ...
            if (e.getRawSlots().stream().mapToInt(slot -> slot).anyMatch(slot -> slot < p.getOpenInventory().getTopInventory().getSize())) {
                e.setCancelled(true);
            }
